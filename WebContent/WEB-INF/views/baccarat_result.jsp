...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/baccarat_result.css"/>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/javascript/baccarat_result.js"></script>
...
<body>
	...
	<br/>
	${vo.tableHtml}
<%-- 	<%= controller.renderBaccaratResultTable() %> --%>
